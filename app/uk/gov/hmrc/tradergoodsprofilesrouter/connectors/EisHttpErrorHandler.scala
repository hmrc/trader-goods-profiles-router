...
import uk.gov.hmrc.tradergoodsprofilesrouter.utils.ApplicationConstants.{AccreditationRequestInProgressCode, AccreditationRequestInProgressMessage, BadGatewayCode, BadGatewayMessage, BadRequestCode, BadRequestMessage, EoriDoesNotExists, EoriDoesNotExistsCode, ForbiddenCode, ForbiddenMessage, InternalErrorResponseCode, InternalErrorResponseMessage, InternalServerErrorCode, InternalServerErrorMessage, InvalidAssessmentPrimaryCategory, InvalidAssessmentPrimaryCategoryCode, InvalidAssessmentPrimaryCategoryConditionDescription, InvalidAssessmentPrimaryCategoryConditionDescriptionCode, InvalidAssessmentPrimaryCategoryConditionId, InvalidAssessmentPrimaryCategoryConditionIdCode, InvalidAssessmentPrimaryCategoryConditionTraderText, InvalidAssessmentPrimaryCategoryConditionTraderTextCode, InvalidAssessmentPrimaryCategoryConditionType, InvalidAssessmentPrimaryCategoryConditionTypeCode, InvalidLastUpdatedDate, InvalidLastUpdatedDateCode, InvalidOrEmptyPayloadCode, InvalidOrEmptyPayloadMessage, InvalidOrMissingActorId, InvalidOrMissingActorIdCode, InvalidOrMissingAssessmentId, InvalidOrMissingAssessmentIdCode, InvalidOrMissingCategory, InvalidOrMissingCategoryCode, InvalidOrMissingComcode, InvalidOrMissingComcodeCode, InvalidOrMissingComcodeEffectiveFromDate, InvalidOrMissingComcodeEffectiveFromDateCode, InvalidOrMissingComcodeEffectiveToDate, InvalidOrMissingComcodeEffectiveToDateCode, InvalidOrMissingCountryOfOrigin, InvalidOrMissingCountryOfOriginCode, InvalidOrMissingEori, InvalidOrMissingEoriCode, InvalidOrMissingGoodsDescription, InvalidOrMissingGoodsDescriptionCode, InvalidOrMissingMeasurementUnit, InvalidOrMissingMeasurementUnitCode, InvalidOrMissingSupplementaryUnit, InvalidOrMissingSupplementaryUnitCode, InvalidOrMissingTraderRef, InvalidOrMissingTraderRefCode, InvalidPage, InvalidPageCode, InvalidRecordId, InvalidRecordIdCode, InvalidSize, InvalidSizeCode, MethodNotAllowedCode, MethodNotAllowedMessage, NotFoundCode, NotFoundMessage, RecordIdDoesNotExists, RecordIdDoesNotExistsCode, RecordRemovedAndCanNotBeUpdatedCode, RecordRemovedAndCanNotBeUpdatedMessage, ServiceUnavailableCode, ServiceUnavailableMessage, TraderRefIsNotUnique, TraderRefIsNotUniqueCode, UnauthorizedCode, UnauthorizedMessage, UnexpectedErrorCode, UnexpectedErrorMessage, UnknownCode, UnknownMessage}
