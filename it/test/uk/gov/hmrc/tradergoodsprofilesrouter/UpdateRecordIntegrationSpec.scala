  ...
  val updateRecordResponseDataWithOptionalFields: JsValue =
    Json
      .parse("""
               ...
               |  "active": true,
               |  "toReview": true,
               |  "reviewReason": "The commodity code or restrictions have changed. You'll need to categorise the record.",
               |  "declarable": "SPIMM",
               |  "ukimsNumber": "XIUKIM47699357400020231115081800",
               |  "nirmsNumber": "RMS-GB-123456",
               |  "niphlNumber": "12345",
  ...
  val updateRecordRequiredResponseData: JsValue =
    Json
      .parse("""
               ...
               |    "active": true,
               |    "toReview": true,
               |    "reviewReason": "HMRC have reviewed the record. The goods description is unclear. If you want to use this record on an IMMI, you'll need to amend the goods description.",
               |    "declarable": "SPIMM",
               |    "ukimsNumber": "XIUKIM47699357400020231115081800",
               |    "nirmsNumber": "RMS-GB-123456",
               |    "niphlNumber": "12345",
